...
import { 
  ...
  LineChart, ArrowLeft, Image, Phone, Zap, Calendar, Truck
} from 'lucide-react';
import { 
...
const navItems: NavItem[] = [
  ...
  { title: 'Bulk Operations', icon: Zap, value: 'bulk-operations', path: '/admin' },
      ...
      <div className="lg:hidden flex items-center justify-between p-4 border-b">
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="left" className="w-[240px] sm:w-[280px]">
            <div className="mb-6">
              <img src="/lovable-uploads/7486a276-d787-490b-a716-26688baba4e0.png" alt="Glintup" className="h-10" />
            </div>
