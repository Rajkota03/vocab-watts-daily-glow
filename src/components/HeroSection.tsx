      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="flex-1 text-center lg:text-left">
            <div className="inline-flex items-center mb-6 bg-vocab-teal/10 py-1.5 px-4 rounded-full text-vocab-teal text-sm font-medium">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight tracking-tight mb-6 font-poppins">
              5 Words a Day. <br />
              <span className="text-vocab-teal relative">
                Smarter You
                <span className="absolute -bottom-2 left-0 w-full h-1 bg-vocab-yellow opacity-70"></span>
              </span> 
              in a Week.
            ...
            <div className="space-y-4 sm:space-y-0 sm:flex sm:flex-row gap-4 justify-center lg:justify-start">
              <Button className="vocab-btn text-base group px-6 py-6 h-auto w-full sm:w-auto">
                Try It Free – Get Today's Words
                <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
              </Button>
              <Button variant="outline" className="vocab-btn-secondary text-base px-6 py-6 h-auto w-full sm:w-auto">
                See Sample Words
              </Button>
            </div>
          ...
          <div className="flex-1 max-w-md animate-float">
            <div className="relative bg-white rounded-3xl shadow-2xl p-5 md:p-7 mx-auto max-w-sm transform rotate-1">
              ...
              <div className="whatsapp-message transition-all hover:shadow-md">
                ...
                <p className="text-sm italic text-gray-600 border-l-2 border-vocab-purple/30 pl-2">It was pure serendipity that I met my business partner at a random coffee shop.</p>
              </div>
              ...
              <div className="mt-4 text-center flex items-center justify-between">
                ...
                <div className="flex -space-x-2">
                  <div className="w-6 h-6 rounded-full border-2 border-white bg-vocab-yellow"></div>
                  <div className="w-6 h-6 rounded-full border-2 border-white bg-vocab-purple"></div>
                  <div className="w-6 h-6 rounded-full border-2 border-white bg-vocab-red"></div>
                </div>
              </div>
