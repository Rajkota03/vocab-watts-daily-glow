...
const Footer = () => {
  return <footer className="text-white py-12 bg-[#edfff1]/[0.31]">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-gray-400 hover:text-accent transition-colors p-2 rounded-full hover:bg-gray-800">
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
          <p>© 2025 <span className="text-white">Glintup</span> — a product of Square Blue Media</p>
        </div>
      </div>
    </footer>;
};
