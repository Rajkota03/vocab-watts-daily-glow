    ...
    <section id="samples" className="py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-6 relative mb-8">
            ...
            <div className="flex items-center mb-4">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs text-gray-600">Today's words for you</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {words.map((wordItem, index) => (
                <div key={index} className="whatsapp-message">
                  <p className="font-bold mb-1">{wordItem.word}</p>
                  <p className="text-sm mb-1">{wordItem.meaning}</p>
                  <p className="text-sm mb-1">Example: {wordItem.example}</p>
                  <p className="text-sm italic">Witty: {wordItem.wittyExample}</p>
                </div>
              ))}
            </div>
          </div>
