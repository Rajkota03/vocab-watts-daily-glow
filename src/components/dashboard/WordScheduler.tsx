...
const CustomTimePicker: React.FC<{
  ...
  return <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        ...
        scale: 0.98
      }} className="group flex items-center gap-2 bg-white border border-stroke rounded-lg hover:bg-gray-50 hover:border-primary/30 transition-all duration-200 py-[4px] px-[12px]">
